...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h1 { font-size: 3rem; font-weight: 700; margin-bottom: 1rem; color: #8b5cf6; }
        ...
        .card { background: #1e293b; border-radius: 12px; padding: 1.5rem; border-left: 4px solid #8b5cf6; }
        .card h3 { color: #8b5cf6; margin-bottom: 0.5rem; }
...
<body>
    <div class="container">
        <div class="hero">
            <h1>emergence-bus-v2</h1>
            <p class="subtitle">Event bus for fleet-wide emergence detection and pattern recognition</p>
        </div>
        ...
        <div class="endpoints">
            <h3 style="color: #8b5cf6; margin-bottom: 1rem;">API Endpoints</h3>
            <div class="endpoint">GET /health → {"status":"ok"}</div>
            <div class="endpoint">POST /api/event → publish event</div><div class="endpoint">GET /api/events → query recent events</div><div class="endpoint">GET /api/patterns → detect emerging patterns</div>
        </div>
